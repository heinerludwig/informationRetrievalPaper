...
\section{Diskussion}
Sowohl die computergestützte Phantombild-Erstellung, als auch die Gestik als Eingabemedium wurden separat vielfach wissenschaftlich untersucht. Die Kombination beider Themengebiete wurde bislang noch nicht untersucht und bietet interessante Möglichkeiten zum Aufbau einer innovativen Nutzungsoberfläche. 
Der stark reglementierte Prozess zum stufenweisen Aufbau eines Phantombildes ist für die Gesten-Eingabe gut geeignet, da keine Notwendigkeit für eine „freie Suche“ besteht und somit bspw. auf Text-Eingaben durchweg verzichtet werden kann. Das erlaubt es, das System sehr einfach zuhalten.
...
erlernen~\cite{vrs:book}. Da Suchanfragen und Ergebnisse prinzipiell
als einfache Objekte dargestellt sind, ergibt sich die Möglichkeit des Einsatzes vieler Freihand-Gesten~\cite{3dinteraction:book}. 
Der Bezug zur Realität (``Objekt nehmen und verschieben'') erleichtet die
Verständlichkeit der Gesten. Zusätzlich bieten Objekte eine Große
...
aufwändiger ist. Im Falle dieser Untersuchung konnte die Notwendigkeit
von komplexen Gesten nur durch den unkonventionellen Aufbau der
virtuellen Oberfläche beschränkt werden. So wird das WIMP-Pattern
aufgeweicht, was möglicherweise zur Verunsicherung bei (routinierten)
Computer-Nutzern führt. Bspw. wurde auf die gewöhnliche
Fensteranordnung oder einen Pointer verzichtet, jedoch spielt die räumlich Entfernung von Objekten eine wichtige Rolle. 
