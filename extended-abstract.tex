...
[S.54] besagt jedoch, dass beim Gro{\ss}teil der gestenbasierten Eingabesysteme sowohl formalisierte, als auch Freihand-Gesten genutzt werden, bspw. bei Interaktionen über grö{\ss}ere Distanzen.
Nicht zuletzt haben Hollywood-Filme wie \textit{Iron Man} oder \textit{Minority Report} zur Inspiration für die User Experience und bei der Erstellung der Nutzungsoberfläche gedient[].
...
ausschlie{\ss}lich als Zuschauer involviert werden. So ist eine
